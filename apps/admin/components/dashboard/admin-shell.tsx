...
export function AdminShell({
  ...
  return (
    <div className="bg-muted/40 dark:bg-background flex h-svh flex-col overflow-hidden">
      ...
      <header className="bg-background border-border/60 sticky top-0 z-30 flex h-18 items-center justify-between border-b px-5 md:hidden">
      ...
      <main className="flex flex-1 flex-col overflow-y-auto md:pl-63.75">
        <div className="mx-auto flex w-full flex-1 flex-col px-4 py-6 md:px-8 md:py-10">
          {children}
        </div>
      </main>
    </div>
