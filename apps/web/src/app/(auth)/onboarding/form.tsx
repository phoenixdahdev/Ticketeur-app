...
import { send_onboarding_response } from '../action'
import { uploadBusinessDocument } from '@useticketeur/ui/upload'
import { useFilePreview } from '@useticketeur/ui/use-file-preview'
  ...
  const handleSubmit = async () => {
    startTransition(async () => {
      ...
      try {
        ...
        const documents = [businessDocResult.url, validIdResult.url].filter(
        ...
        toast.success(
          'Documents submitted successfully! Admin will review your submission.'
        )
        router.push('/tour')
      } catch (err) {
