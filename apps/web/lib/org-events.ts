export type EventStatus =
  'upcoming' | 'in-review' | 'draft' | 'archived' | 'suspended'
...
export const STATUS_TONE: Record<EventStatus, string> = {
  ...
  'in-review': 'bg-sky-100 text-sky-700 dark:bg-sky-500/15 dark:text-sky-400',
